...
* Data are from the original [Kaggle link](https://www.kaggle.com/airbnb/seattle). `listings` and `calendar` datasets are used for this analysis. 
  ** `calendar` dataset contains home_id, date, availability, and price for the day available
  ** `listings` dataset contains home_id, address, home characteristics, and reviews
